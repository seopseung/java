...
public class Ex35_String {
	...
	private static void m2() {
		...
		//1. 문자열의 잦은 수정(for문으로 수천번 반복하면 체감됨)
		//2. 커다란 문자열의 수정(덩어리가 전체적으로 지워졌다 만들어지기 때문에 메모리 낭비 - 작업이 무거워짐)
		...
		txt1 = "홍길동입니다. 홍길동입니다. 홍길동입니다. 홍길동입니다. 홍길동입니다. 홍길동입니다. 홍길동입니다. 홍길동입니다. ";
	...
	private static void m1() {
		...
		System.out.println(s1 == s3); // 절대 사용 금지!! 문자열이 같은지를 비교하려면 equals라는 메소드를 사용해야함
